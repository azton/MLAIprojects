...
class BasicConv(nn.Block):
    ...
    def __init__(self,c2, kernel_size=3, strides=1, padding=1, activation='relu'):
        ...
        self.c1 = nn.Conv2D(c2, kernel_size=kernel_size, \
...
class Reduction(nn.Block):
    def __init__(self, c1, c2):
        ...
        self.pool = nn.MaxPool2D(pool_size=2, strides=1)
...
class Expansion(nn.Block):
    def __init__(self, c1, c2):
        ...
        self.upconv = nn.Conv2DTranspose(c1, kernel_size=2, strides=1, padding=0,\
                        activation='relu')
